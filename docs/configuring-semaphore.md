...
See its [environment variables](https://docs.semaphoreui.com/administration-guide/configuration/) for a complete list of Semaphore UI's config options that you can put in `semaphore_environment_variables_additional_variables`.
